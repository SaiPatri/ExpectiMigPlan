...
class ExpectiNPVBusiness:
    ...
    def __init__(self, filename,START_YEAR, MAX_YEAR, pen_curve,depth_100,only_ftth):
        ...
        # Here non FTTH technologies can also provide 100 mbps
...
def run_expecti_business(inputfile, startyear, maxyear, penetration_curve,depth_all_100,only_ftth):
...
if __name__ == "__main__":
    ...
    print('Business Case: Residential+Business Customers')
    input_file = sys.argv[1]
    start_year = sys.argv[2]
    end_year = sys.argv[3]
    result_filename = 'results_expectimax_business'
