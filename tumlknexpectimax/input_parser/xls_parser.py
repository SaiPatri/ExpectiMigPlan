...
class Parser:
    ...
    CURRENT_WORKING_DIR = os.getcwd()+'\\excel_data'
...
if __name__ == "__main__":
    parsed = Parser()
    adsl0,fttc1, fttb2, fttb3, ftth4, ftth5, fttc6force, fttb7force, fttb8force, fttchybrid9,fttbhybrid10,ftthhybrid11,fttchybridforce12,fttbhybridforce13, capex, mig_capex = parsed.xls_parse_residential('input_data_new_churn.xlsx')
    max_year = 2038
    current_year = 2018
    pen_curve = 'Aggr PV'
    # print sum([fttc1.loc[year][pen_curve] for year in range(current_year,max_year+1)])
    print(mig_capex.iloc[13][11])
